package com.jumbotours.commons.lang.ascii;
...
public final class ASCIINormalizerUtils {
	 ...
	 * @return the string
	 */
	public static String inputToASCII(String input) {
		char[] output = new char[4 * input.length()];
		inputToASCII(input.toCharArray(), 0, output, 0, input.length());
		return StringUtils.trim(new String(output));
	}
	 ...
	 * @param output
	 *            The result of the folding. Should be of size >= {@code length * 4}.
	 * @param outputPos
	...
	public static int inputToASCII(char input[], int inputPos, char output[], int outputPos, int length) {
